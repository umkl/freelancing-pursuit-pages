	...
	return (
		<section className="flex-1 w-full h-full relative overflow-hidden ">
			<div className="h-full w-full overflow-hidden absolute ">
				<div className="flex w-full uppercase font-bold text-neutral-900 py-4 px-8">
				...
				<div className="relative">
					<div className="absolute from-neutral-100/100 bg-gradient-to-t to-neutral-100/0 w-full h-full"></div>
